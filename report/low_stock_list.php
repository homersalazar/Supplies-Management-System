...
<div id="main">
    <div class="row ml-5">
        <div class="col-11">
            ...
            ?>
            <button type="button" class="btn btn-outline-success btn-sm mt-2 mb-2" onclick="exportTableToExcel('low_stock_table','Low_stock')">Export to Excel</button>
            <table id="low_stock_table" class="table table-bordered">
                <thead class="thead-light pt-2">
                    <th style='width: 20%; text-align:left; padding-left:50px; !important'>Item Name</th>
                    <th style='width: 14%; text-align:center; !important'>In-stock</th>
